...
function InputVibrateDirect(_device, _left, _right)
{
    if (INPUT_ON_SWITCH)
    {
        ...
        if ((_gamepadType == INPUT_GAMEPAD_TYPE_JOYCON_LEFT) or (_gamepadType == INPUT_GAMEPAD_TYPE_JOYCON_RIGHT))
        {
    ...
    else
    {
        ...
        else if (INPUT_FIX_PS_NATIVE_VIBRATION_SIDE and (INPUT_ON_PS4 or INPUT_ON_PS5))
        {
